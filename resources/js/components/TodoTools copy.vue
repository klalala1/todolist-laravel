            ...
            <div class="todo-list-user">
                ...
                >
                    ...
                    >
                        ...
                        {{ item.description }} <br /><b>Due Dates </b>
                        {{ item.due_dates }}<br />
                ...
                <button
                    v-if="$store.state.items.add == null"
                ...
                <AddEditTodo
                    v-else-if="$store.state.items.add == date"
                ></AddEditTodo>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        addTask(date) {
            this.$store.commit("items/toggleAdd", date);
